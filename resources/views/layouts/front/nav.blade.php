    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-xs-12 col-sm-3 col-md-3">
                ...
                <div class="logo">
                    <a href="index.html">
                        <img src="{{ asset('asset/front/images/logos/logo.png')}}" alt=""> <!-- Replace Logo Here -->
                    </a>
                </div>
                <!-- End Logo -->
            </div>
            <div class="col-xs-12 col-sm-9 col-md-9">
                <div class="top-ad-banner float-right">
                    <a href="#">
                        <img src="{{ asset('asset/front/images/news/ad-pro.png')}}" class="img-fluid" alt="banner-ads">
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="{{ route('home2') }}">Home 2</a>
                                </div>
                            </li>
