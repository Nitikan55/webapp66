        ...
        <div class="row no-gutters">
            ...
            <div class="col-md-6 col-xs-12 col-lg-4">
                <div class="featured-slider">
                    <div class="item ml-lg-3 mr-lg-3" style="background-image:url({{ asset('asset/front/images/news/img-2.jpg') }})">
                        <div class="post-content">
            ...
            <div class="col-md-6 col-xs-12 col-lg-4">
                <div class="featured-slider">
                    <div class="item mr-0" style="background-image:url({{ asset('asset/front/images/news/img-1.jpg') }})">
                        <div class="post-content">
